# Write a function that takes in a list of jobs and a list of dependencies and rturn a list
# containing a valid order in which the given jobs can be completed. If no such order exists, the functions should return an empty array
