...
# substring of the main string. The function should return a version of the 
# main string with every instance of the substring in it wrapped between underscores.
